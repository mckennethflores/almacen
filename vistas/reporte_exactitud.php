                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                       ...
                       <!--  <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <button class="btn btn-primary" onclick="listarStockDeProductos()"><i class="fa fa-save"></i> Consultar</button>
                        </div>

                 
                        <table id="tbllistado_exactitud" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            <th>Codigo</th>
                            <th>Producto</th>
                            <th>Cant. Stock. Sistema</th>
                            <th>Cant. Stock. Fisico</th>
                            <th>Exactitud</th>
                          </thead>
                          <tbody>                            
                          </tbody>
